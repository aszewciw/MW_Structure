...
void load_rbins(POINTING *plist, int N_bins, int lower_ind, int upper_ind,
  int rank, char in_dir[], char dd_dir[]);
void load_pairs(POINTING *plist, int N_bins, int lower_ind, int upper_ind,
