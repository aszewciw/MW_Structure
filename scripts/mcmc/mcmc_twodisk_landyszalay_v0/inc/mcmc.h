...
typedef struct {
  ...
  unsigned int N_MR;    /* number of unique MR pairs */
  int * MM_pair1;       /* array of MM pair1 index of length N_pairs */
  int * MM_pair2;       /* array of MM pair2 index of length N_pairs */
