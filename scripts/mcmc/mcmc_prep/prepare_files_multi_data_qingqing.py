...
def main():
    ...
    dd_jk_dir = args_array[5]
    rr_jk_dir = args_array[6]
    ...
    sys.stderr.write('Data stats directory is {}\n'.format(dd_jk_dir))
    sys.stderr.write('Model stats directory is {}\n'.format(rr_jk_dir))
    ...
    for i in ID:
        ...
        # get dd counts and jk error file
        ...
        # Copy rr fractional error file
        stats_fname = rr_jk_dir + 'frac_err_jk_RR_' + i + '.dat'
        cmd = 'cp ' + stats_fname + ' ' + out_dir + 'frac_err_jk_RR_' + i + '.dat'
        os.system(cmd)
