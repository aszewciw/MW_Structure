...
typedef struct PARAMS{
    ...
    /* CDF constant for thin height */
    double z0_cdf_const_thin;
    /* CDF constant for thin length */
    double r0_cdf_const_thin;
    ...
    /* CDF constant for thick height */
    double z0_cdf_const_thick;
    /* CDF constant for thick length */
    double r0_cdf_const_thick;
...
/* Generation of stars */
double random_gal_Z(double z0, double pdf_norm, double cdf_const, double z_min, double z_max);
double random_gal_R(double r0, double pdf_norm, double cdf_const, double r_min, double r_max);
