...
def main():
    ...
    for ID in ID_list:
        ...
        dd = np.delete(dd, exclude_list)
        mm_rid = np.delete(mm_rid, exclude_list)
        mm_true = np.delete(mm_true, exclude_list)
        fid_mean = np.delete(fid_mean, exclude_list)
        fid_std = np.delete(fid_std, exclude_list)
        true_mean = np.delete(true_mean, exclude_list)
        true_std = np.delete(true_std, exclude_list)
        rid_mean = np.delete(rid_mean, exclude_list)
        rid_std = np.delete(rid_std, exclude_list)
